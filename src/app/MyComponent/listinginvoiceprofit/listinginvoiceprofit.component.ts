...
@Component({
  selector: 'app-listinginvoiceprofit',
  templateUrl: './listinginvoiceprofit.component.html',
  styleUrl: './listinginvoiceprofit.component.css'
})
export class ListinginvoiceprofitComponent {
